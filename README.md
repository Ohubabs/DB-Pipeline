...
-	Edit the var.tf file with the custom url for your jenkins application to be accessed over the internet, email, private secret key name (this will be autogenerated), and registered hosted zone ID for your AWS registered domain name.
